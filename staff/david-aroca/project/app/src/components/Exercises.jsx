...
function Exercises({ refreshStamp }) {
    ...
    const handleSearchExercises = (event) => {
    ...
    return (
        <section className="flex flex-col gap-6 px-2 py-14">
            <form className='mt-20' onSubmit={handleSearchExercises}>
                <input
                    name="query"
                    type="text"
            ...
            {userRole === 'trainer' && (
                <button
                    className="fixed right-0 top-20 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded z-10"
