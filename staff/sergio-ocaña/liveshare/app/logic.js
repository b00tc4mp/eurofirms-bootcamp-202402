...
var logic = (function () {
    ...
    function convertDateToISOString(date) {
        ...
        var isoDate = isoDate = year + '-' + twoDigits(month) + '-' + twoDigits(day) + ' ' + twoDigits(hours) + ':' +
    ...
    function validateUserId(userId) {
        ...
        if (userId.includes(' ')) throw new Error('text has spaces')
    ...
    function retrieveMessagesWithUser(userId) {
        ...
        var messages = data.findMessages(function (message) {
            return message.from === sessionStorage.userId && message.to === userId || message.from === userId &&
                message.to === sessionStorage.userId
        })
        return messages
    }
    return {
