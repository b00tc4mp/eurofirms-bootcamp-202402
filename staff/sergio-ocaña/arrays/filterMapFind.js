...
var users = [
    {
        name: 'wendy', email: 'wendy@darling.com', messages: [
    ...
    {
        name: 'peter', email: 'peter@pan.com', messages: [
...
var user = users.find(function (uss) {
    return uss.email === 'pepito@grillo.com'
})

var messages = user.messages.filter(function (mssg) {
    return mssg.to === 'wendy'
})

var arr = messages.map(function (msg) {
    return msg.text
})
console.log(arr)