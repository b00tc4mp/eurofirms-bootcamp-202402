    ...
    >
      ...
      <div className="flex flex-1 justify-between sm:justify-end">
        {initialReportedCommentsPaginated.hasPrevPage && (
          <Link
            to={`/reportedSearches?limit=${initialReportedCommentsPaginated.limit}&page=${initialReportedCommentsPaginated.prevPage}`}
        ...
        {initialReportedCommentsPaginated.hasNextPage && (
          <Link
            to={`/reportedSearches?limit=${initialReportedCommentsPaginated.limit}&page=${initialReportedCommentsPaginated.nextPage}`}
