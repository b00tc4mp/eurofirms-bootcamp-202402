var products = [
  {
    ...
    image:
      "https://assets.mmsrg.com/isr/166325/c1/-/ASSET_MMS_106186290?x=600&y=450&format=jpg&quality=80&sp=yes&strip=yes&trim&ex=600&ey=450&align=center&resizesource&unsharp=1.5x1+0.7+0.02&cox=0&coy=0&cdx=600&cdy=450",
    imageAlt: "Portatil ASUS Vivobook",
    description:
      'Portátil - ASUS Vivobook F1605PA-MB143, 16" WUXGA, Intel® Core™ i7-11370H, 8GB RAM, 512GB SSD, Iris® Xe Graphics, Sin sistema operativo',
    price: "499€",
  },
  {
    title: "Portatil HP",
    image:
      "https://assets.mmsrg.com/isr/166325/c1/-/ASSET_MMS_133306750?x=320&y=320&format=jpg&quality=80&sp=yes&strip=yes&trim&ex=320&ey=320&align=center&resizesource&unsharp=1.5x1+0.7+0.02&cox=0&coy=0&cdx=320&cdy=320",
    imageAlt: "Portail HP",
    description:
      'Portátil - HP 15-fd0041ns, 15.6" Full HD, Intel® Core™ i3-N305, 8GB RAM, 512GB SSD, UHD Graphics, W11 H',
    price: "449€",
  },
];
