...
function validateName(name) {
  ...
  if (name.length < 1) throw new RangeError('name is lower than 1 character');
  ...
  if (nameIsBlank) throw new ContentError('name is blank');
}

function validateBirthdate(birthdate) {
  if (typeof birthdate !== 'string')
    throw new TypeError('birthdate is not string');
