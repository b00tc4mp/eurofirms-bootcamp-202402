...
var stringLength = strings.map(function(str) {
    return str.length
})
console.log(stringLength) // received: [4, 5, 1 ,5]
...
var restNumber = numbers2.map(function(number) {
    return number % 2
}
)
console.log(restNumber) // received: [0, 0, 0, 1, 0]
//---------------------------------------------------------------
