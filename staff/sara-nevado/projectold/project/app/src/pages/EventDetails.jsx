...
function EventDetails({ eventDetails, user, closeEventDetails }) {
  const selectedBy = eventDetails.subscribers.map(subscriberId => subscriberId).join(', ')
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-gray-700 p-4 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <p><strong>Seleccionado por:</strong> {selectedBy}</p>
